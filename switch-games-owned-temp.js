export const switchGamesOwnedFromAPI = [
  {
    title: 'Aggelos',
    description:
    ...
    url: '/games/detail/aggelos-switch/',
    nsuid: '70010000012683',
    slug: 'aggelos-switch',
    boxart:
    ...
    playerFilters: ['1+'],
    msrp: 14.99,
    objectID: '0f7145c7-34c1-441c-bbeb-b53cc846d530',
    myData: {
      title: 'Aggelos',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/axiom-verge-2-switch/',
    ...
    generalFilters: ['Nintendo Switch Online compatible'],
    playerFilters: ['1+'],
    nsuid: '70010000026128',
    msrp: 19.99,
    objectID: 'a1a5dba6-443b-41d6-a779-4c63bba016b4',
    myData: {
      title: 'Axiom Verge 2',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/blasphemous-switch/',
    nsuid: '70010000007282',
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: 'c327a188-de69-45c1-8975-906a043365d1',
    myData: {
      title: 'Blasphemous',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/bloodstained-ritual-of-the-night-switch/',
    nsuid: '70010000019475',
    ...
    freeToStart: false,
    esrbDescriptors: ['Blood', 'Partial Nudity', 'Violence', 'Users Interact'],
    franchises: ['Metroid'],
    ...
    playerFilters: ['1+', '2+'],
    msrp: 39.99,
    objectID: 'e3a07ca6-107f-420c-9b8c-02cdece84d14',
    myData: {
      title: 'Bloodstained: Ritual of the Night',
  ...
  },
  {
    ...
    url: '/games/detail/borderlands-legendary-collection-switch/',
    nsuid: '70070000010161',
    ...
    msrp: 49.99,
    objectID: 'd244a044-06f5-4b97-8259-f25b4aa31c79',
    myData: {
      title: 'Borderlands 2 Game of the Year Edition',
      matchTitle: 'Borderlands Legendary Collection',
      played: true,
      physicalCopy: false
    }
  },
  {
    ...
    url: '/games/detail/borderlands-game-of-the-year-edition-switch/',
    nsuid: '70010000022955',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 29.99,
    objectID: '33a2573a-84f1-40d9-b245-3dce2765cebb',
    myData: {
      title: 'Borderlands Game of the Year Edition',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/cat-quest-plus-cat-quest-ii-pawsome-pack-switch/',
    nsuid: '70010000028359',
    ...
    playerFilters: ['1+'],
    msrp: null,
    objectID: '8567cfb5-e3a4-48f4-9b55-6ddcd12c8ec8',
    myData: {
      title: 'Cat Quest 2',
      matchTitle: 'Cat Quest II',
      played: true,
      physicalCopy: false
    }
  },
  {
    ...
    url: '/games/detail/celeste-switch/',
    ...
    numOfPlayers: '1 player',
    freeToStart: false,
    esrbDescriptors: ['Alcohol Reference', 'Fantasy Violence', 'Mild Language'],
    franchises: [],
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: 'd72a6970-f8cb-430a-9373-315ea4e8c6df',
    myData: {
      title: 'Celeste',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/child-of-light-ultimate-edition-switch/',
    nsuid: '70010000009989',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 19.99,
    objectID: '4098f563-58f3-4851-9378-4d07638f2c58',
    myData: {
      title: 'Child of Light',
      matchTitle: 'Child of Light: Ultimate Edition',
      played: true,
      physicalCopy: false
    }
  },
  {
    ...
    url: '/games/detail/chrono-cross-the-radical-dreamers-edition-switch/',
    nsuid: '70010000032650',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '5b4f2994-328c-441b-891d-2cff2340f9b7',
    myData: {
      title: 'Chrono Cross: The Radical Dreamers Edition',
  ...
  },
  {
    ...
    url: '/games/detail/dark-souls-remastered-switch/',
    nsuid: '70010000008122',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 39.99,
    objectID: 'efac6b9d-1d99-49be-ac5d-ea8c2fcdb622',
    myData: {
      title: 'Dark Souls: Remastered',
  ...
  },
  {
    ...
    url: '/games/detail/dexter-stardust-adventures-in-outer-space-switch/',
    nsuid: '70010000042478',
    ...
    playerFilters: ['1+'],
    msrp: 9.99,
    objectID: 'debc21b2-2c33-4f97-8e27-8cfc889d8ef7',
    myData: {
      title: 'Dex',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/dicey-dungeons-switch/',
    nsuid: '70010000028411',
    ...
    playerFilters: ['1+'],
    msrp: 14.99,
    objectID: '3d5a6079-1a16-4ee0-8219-89693f53884d',
    myData: {
      title: 'Dicey Dungeons',
  ...
  },
  {
    ...
    url: '/games/detail/dont-starve-together-switch/',
    nsuid: '70010000019795',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 14.99,
    objectID: '31302ff9-d342-464d-9d03-6563dcd53cc9',
    myData: {
      title: "Don't Starve Together",
  ...
  },
  {
    ...
    url: '/games/detail/doom-1993-switch/',
    nsuid: '70010000018923',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 4.99,
    objectID: '835ff366-6a7d-481e-b3c3-3090d6133e1a',
    myData: {
      title: 'Doom (1993)',
  ...
  },
  {
    ...
    url: '/games/detail/doomsday-vault-switch/',
    nsuid: '70010000032234',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '48e20ea8-9051-4f0a-ac42-b4f8f4849e8b',
    myData: {
      title: 'Doom (2016)',
      matchTitle: 'Doom',
      played: true,
  ...
  },
  {
    ...
    url: '/games/detail/doom-eternal-switch/',
    nsuid: '70070000011025',
    ...
    playerFilters: ['1+', '2+', '3+'],
    msrp: 59.99,
    objectID: '61588e4c-6c52-454e-b6c1-9cf398003d85',
    myData: {
      title: 'Doom Eternal',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/dragon-quest-xi-s-echoes-of-an-elusive-age-definitive-edition-switch/',
    nsuid: '70010000021451',
    ...
    playerFilters: ['1+'],
    msrp: 49.99,
    objectID: '05b09c54-b507-4a79-9daf-cd76451ed2b8',
    myData: {
  ...
  },
  {
    ...
    url: '/games/detail/eastward-switch/',
    nsuid: '70010000022882',
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: '7f32b7ff-c0d8-412f-ab7a-fa416ea0d42a',
    myData: {
      title: 'Eastward',
      played: true,
      fullOrDemo: 'demo',
  ...
  },
  {
    ...
    url: '/games/detail/ender-lilies-quietus-of-the-knights-switch/',
    nsuid: '70010000035193',
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: '1cf1848c-737c-4699-a0e0-e34e342ba45c',
    myData: {
      title: 'Ender Lilies: Quietus of the Knights',
  ...
  },
  {
    ...
    url: '/games/detail/figment-switch/',
    nsuid: '70010000007275',
    slug: 'figment-switch',
    boxart:
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '007fa555-6ac3-4abf-94ad-fed1eb8ea7fd',
    myData: {
      title: 'Figment',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/fortnite-switch/',
    nsuid: '70010000010192',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 0,
    objectID: 'a1278c0d-b61f-4a34-bcfc-6b0b9a7965a6',
    myData: {
      title: 'Fortnite',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/hades-switch/',
    nsuid: '70010000033131',
    slug: 'hades-switch',
    boxart:
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: '81f279ad-29b2-41b1-9dc1-2eaa60a26b4a',
    myData: {
      title: 'Hades',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/hyrule-warriors-age-of-calamity-switch/',
    nsuid: '70010000034760',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 59.99,
    objectID: '13ad2da9-8c00-4b20-bb3e-4a2b80b268e1',
    myData: {
      title: 'Hyrule Warriors: Age of Calamity',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/into-the-breach-switch/',
    nsuid: '70010000011496',
    ...
    playerFilters: ['1+'],
    msrp: 14.99,
    objectID: '5a0449db-872f-4ae1-a389-baf6bfb74099',
    myData: {
      title: 'Into The Breach',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/kirby-and-the-forgotten-land-switch/',
    ...
    msrp: 59.99,
    objectID: 'ae7c0055-3743-4edb-a961-845c74f7a701',
    myData: {
      title: 'Kirby and the Forgotten Land',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/legend-of-mana-switch/',
    nsuid: '70010000034471',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 29.99,
    objectID: 'bfd99647-13ea-41d5-9c06-b3ecc36831d1',
    myData: {
      title: 'Legend of Mana',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/limbo-switch/',
    nsuid: '70010000005802',
    slug: 'limbo-switch',
    boxart:
    ...
    playerFilters: ['1+'],
    msrp: 9.99,
    objectID: 'f6509228-2617-44a5-89b2-c371c7800e8e',
    myData: {
      title: 'Limbo',
  ...
  },
  {
    ...
    url: '/games/detail/mario-plus-rabbids-kingdom-battle-gold-edition-switch/',
    nsuid: '70070000000521',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 79.99,
    objectID: '923f323a-f2a8-48d1-963e-0fe2016057d8',
    myData: {
  ...
  },
  {
    ...
    url: '/games/detail/mario-plus-rabbids-sparks-of-hope-switch/',
    nsuid: '70010000035797',
    ...
    msrp: null,
    _distinctSeqID: 0,
    objectID: 'c0c27648-3224-4b6c-8bfb-c572d68a6e8c',
    myData: {
      title: 'Mario + Rabbids Sparks of Hope',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/metal-slug-tactics-switch/',
    nsuid: '70010000043042',
    ...
    playerFilters: ['1+'],
    msrp: null,
    objectID: 'e3752b83-725a-4177-9725-800793f556b3',
    myData: {
      title: 'Metal Slug Tactics',
  ...
  },
  {
    ...
    url: '/games/detail/metroid-dread-switch/',
    ...
    msrp: 59.99,
    _distinctSeqID: 0,
    objectID: 'b8c76d50-f97c-433d-bc4f-24d694986868',
    myData: {
      title: 'Metroid Dread',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/monster-boy-and-the-cursed-kingdom-switch/',
    nsuid: '70010000013435',
    ...
    playerFilters: ['1+'],
    msrp: 39.99,
    objectID: 'a9930c8c-9f9e-4e2a-b2bf-f1844ec4c938',
    myData: {
      title: 'Monster Boy',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/mortal-kombat11-switch/',
    nsuid: '70010000015154',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 49.99,
    objectID: '44bfb8cb-1511-4b88-85bb-7fda474b3e7b',
    myData: {
      title: 'Mortal Kombat 11',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/new-pokemon-snap-switch/',
    nsuid: '70010000037989',
    ...
    playerFilters: ['1+'],
    msrp: 59.99,
    objectID: '4f041b66-ea23-4f67-93d4-ae3443318078',
    myData: {
  ...
  },
  {
    ...
    url: '/games/detail/owlboy-switch/',
    nsuid: '70010000001284',
    slug: 'owlboy-switch',
    boxart:
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: 'b0adc8c2-7999-4c82-9cb4-fd6f90f57f22',
    myData: {
      title: 'OwlBoy',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/pokemon-sword-and-pokemon-shield-double-pack-switch/',
    ...
    generalFilters: ['DLC available', 'Nintendo Switch Online compatible'],
    playerFilters: ['1+', '2+', '3+', '4+'],
    objectID: '84c3810d-9af4-411f-9aef-125e824fae2a',
    myData: {
  ...
  },
  {
    ...
    url: '/games/detail/pokemon-unite-switch/',
    nsuid: '70010000043292',
    ...
    playerFilters: ['1+'],
    msrp: 0,
    objectID: 'f9792eba-650a-41d4-b02b-7bc0418dcaca',
    myData: {
      title: 'Pokemon Unite',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/quake-switch/',
    nsuid: '70010000034060',
    slug: 'quake-switch',
    horizontalHeaderImage:
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 9.99,
    objectID: 'c7e62272-b9dc-401d-810c-7912d0af8f7f',
    myData: {
      title: 'Quake',
  ...
  },
  {
    ...
    url: '/games/detail/rayman-legends-definitive-edition-switch/',
    nsuid: '70010000001017',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 39.99,
    objectID: '7731693d-765b-4fa8-b37f-e8e29fd65cbe',
    myData: {
      title: 'Rayman Legends: Definitive Edition',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/resident-evil-switch/',
    nsuid: '70010000012854',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '721ac309-cdd3-4157-a1c6-0cf54cb5eeda',
    myData: {
      title: 'Resident Evil',
  ...
  },
  {
    ...
    url: '/games/detail/ring-fit-adventure-switch/',
    nsuid: '70010000004566',
    ...
    playerFilters: ['1+'],
    msrp: null,
    objectID: '97c2b0ab-61ca-4d39-a559-54a52e24eda2',
    myData: {
      title: 'Ring Fit',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/sea-of-stars-switch/',
    nsuid: '70010000046189',
    ...
    playerFilters: ['1+', '2+'],
    msrp: null,
    objectID: '5f41e7ec-ec4f-400e-8264-455d93c7131a',
    myData: {
      title: 'Sea of Stars',
  ...
  },
  {
    ...
    url: '/games/detail/shantae-half-genie-hero-switch/',
    nsuid: '70010000000723',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '6b2dec20-d218-4f2b-be33-493dd9eb1249',
    myData: {
      title: 'Shantae: Half-Genie Hero',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/shovel-knight-treasure-trove-switch/',
    nsuid: '70010000000121',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 39.99,
    objectID: '8dab9883-c39e-46ba-9fd2-047103095dc8',
    myData: {
      title: 'Shovel Knight: Treasure Trove',
  ...
  },
  {
    ...
    url: '/games/detail/sonic-mania-switch/',
    nsuid: '70010000000809',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 19.99,
    objectID: 'dde12085-6df3-4150-b308-44de3e4bd50a',
    myData: {
      title: 'Sonic Mania',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/sonic-origins-switch/',
    nsuid: '70010000045649',
    ...
    playerFilters: ['1+'],
    msrp: 39.99,
    objectID: '0cae4cee-c6a8-4efe-933d-c9d2025a5851',
    myData: {
      title: 'Sonic Origins',
  ...
  },
  {
    ...
    url: '/games/detail/steamworld-dig-2-switch/',
    nsuid: '70010000002088',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: 'de94907c-503d-4b4c-b4ed-d8d0fee2f57b',
    myData: {
      title: 'SteamWorld Dig 2',
  ...
  },
  {
    ...
    url: '/games/detail/steamworld-heist-ultimate-edition-switch/',
    nsuid: '70010000003749',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '0b49881d-be6e-4ee8-9d1b-3f8c6e861f4d',
    myData: {
      title: 'SteamWorld Heist: Ultimate Edition',
      dateBought: '04/07/2023',
      paid: 4.81,
  ...
  },
  {
    ...
    url: '/games/detail/steamworld-quest-hand-of-gilgamech-switch/',
    nsuid: '70010000017876',
    ...
    playerFilters: ['1+'],
    msrp: 24.99,
    objectID: '2dbc1250-3319-4e02-bb5b-2140b693c6ad',
    myData: {
      title: 'SteamWorld Quest: Hand of Gilgamech',
  ...
  },
  {
    ...
    url: '/games/detail/streets-of-rage-4-switch/',
    nsuid: '70010000026150',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 24.99,
    objectID: 'ce23d03a-bc4f-4b06-b1d9-ec781c9ec41f',
    myData: {
      title: 'Streets of Rage 4',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/super-mario-3d-world-plus-bowsers-fury-switch/',
    nsuid: '70010000034439',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 59.99,
    objectID: '35157a65-e086-4306-8ac7-7986dbc5f98a',
    myData: {
      title: "Super Mario 3D World + Bowser's Fury",
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/super-mario-odyssey-switch/',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 59.99,
    objectID: 'aa29a884-2823-49fd-83b5-f6db6c6737c2',
    myData: {
      title: 'Super Mario Odyssey',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/super-mario-party-switch/',
    nsuid: '70010000014158',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 59.99,
    objectID: 'c8dbd8a2-f3ac-4012-87ed-2cbe53ea8d67',
    myData: {
      title: 'Super Mario Party',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/teenage-mutant-ninja-turtles-shredders-revenge-switch/',
    nsuid: '70010000039366',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 24.99,
    objectID: '9c8d88ee-7dee-4fca-9a7b-3d5938061e6f',
    myData: {
      title: "Teenage Mutant Ninja Turtles: Shredder's Revenge",
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/tetris-99-switch/',
    nsuid: '70010000018547',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 0,
    objectID: 'd7ddc443-b5f2-49a9-a17d-8a2371fe2428',
    myData: {
      title: 'Tetris 99',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/tetris-effect-connected-switch/',
    nsuid: '70010000038380',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 39.99,
    objectID: 'a724fe5e-7ecf-409a-b36b-ff9cc38715c7',
    myData: {
      title: 'Tetris Effect: Connected',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/the-legend-of-zelda-breath-of-the-wild-switch/',
    ...
    playerFilters: ['1+'],
    msrp: 59.99,
    objectID: '5761de65-c93b-4ec7-99c7-919427220ec2',
    myData: {
      title: 'The Legend of Zelda: Breath of the Wild',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/the-witcher-3-wild-hunt-switch/',
    nsuid: '70010000033071',
    ...
    playerFilters: ['1+'],
    msrp: 39.99,
    objectID: 'fb42a733-17d8-42e6-87d9-9798cf895c03',
    myData: {
      title: 'The Witcher 3: Wild Hunt',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/toem-switch/',
    nsuid: '70010000041461',
    slug: 'toem-switch',
    horizontalHeaderImage:
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '6974f3a6-37c6-48db-8f56-625dc74519c2',
    myData: {
      title: 'Toem',
  ...
  },
  {
    ...
    url: '/games/detail/transistor-switch/',
    nsuid: '70010000013383',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: '775a7fb0-8a6c-4a5f-82f9-dea130ae4894',
    myData: {
      title: 'Transistor',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/underhero-switch/',
    nsuid: '70010000023430',
    ...
    playerFilters: ['1+'],
    msrp: 16.99,
    objectID: '90ea078a-a8c3-4165-8abd-71aa86f74f19',
    myData: {
      title: 'UnderHero',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/valfaris-and-slain-double-pack-switch/',
    nsuid: '70010000028805',
    ...
    playerFilters: ['1+'],
    msrp: 39.99,
    objectID: 'e2ccd5fb-ba48-4bb3-a0e9-0a1b6b3cbe53',
    myData: {
      title: 'Valfaris & Slain Double Pack',
  ...
  },
  {
    ...
    url: '/games/detail/worms-wmd-switch/',
    nsuid: '70010000001330',
    ...
    playerFilters: ['1+', '2+', '3+', '4+'],
    msrp: 29.99,
    objectID: 'e1824628-ade5-4ce6-adb9-c8f663ee748f',
    myData: {
      title: 'Worms W.M.D.',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/xcom-2-collection-switch/',
    nsuid: '70010000025496',
    ...
    playerFilters: ['1+'],
    msrp: 49.99,
    objectID: '0d49156f-7d2e-4e1c-828b-44baabedefd2',
    myData: {
      title: 'XCOM 2 Collection',
      dateBought: '12/21/2023',
      paid: 0,
  ...
  },
  {
    ...
    url: '/games/detail/xenoblade-chronicles-3-switch/',
    ...
    generalFilters: [],
    playerFilters: ['1+'],
    objectID: 'a935d8f6-9930-4f8a-96e9-02ece771260d',
    myData: {
      title: 'Xenoblade Chronicles 3',
      played: true,
      physicalCopy: true
  ...
  },
  {
    ...
    url: '/games/detail/yokus-island-express-switch/',
    nsuid: '70010000001576',
    ...
    playerFilters: ['1+'],
    msrp: 19.99,
    objectID: 'fe8e5334-b5fe-440e-b5fa-9de1ba5cfe25',
    myData: {
      title: "Yoku's Island Express",
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/yooka-laylee-and-the-impossible-lair-switch/',
    nsuid: '70010000018416',
    ...
    playerFilters: ['1+'],
    msrp: 29.99,
    objectID: '6be574c9-92a2-438b-9407-10629794ae4b',
    myData: {
      title: 'Yooka-Laylee and the Impossible Lair',
      played: true,
      physicalCopy: false
  ...
  },
  {
    ...
    url: '/games/detail/yoshis-crafted-world-switch/',
    ...
    playerFilters: ['1+', '2+'],
    msrp: 59.99,
    objectID: 'cd6f8ccb-6459-4b7c-8856-5bb00eba8480',
    myData: {
      title: "Yoshi's Crafted World",
      played: true,
      physicalCopy: true
...
export const switchGamesOwnedManualEntry = [
  {
    title: 'Animal Well',
    description:
...
export const switchGamesOwnedMasterList = [
  ...switchGamesOwnedFromAPI,
  switchGamesOwnedManualEntry
]
